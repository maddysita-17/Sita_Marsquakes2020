...
mechanism_dict = {
                    ...
                    'S0173ab':  [[30,48,-12],],     # NewGud Top Mech @ 35km
                    }
...
def forwardcalc(depth,mechdic,alt=False):
    ...
    if 'S0173ab' in mechdic:
        ...
        for i in range(len(data173ab)):
            data173ab.at[i,'Model'] = mod
        data173ab.to_csv(path+'/fwdcalc-173ab.csv', mode='a',header=False)
        ...
        #     for i in range(len(data1)):
        #         data1.at[i,'Model'] = 'InSight'
        #     data1.to_csv(path+'/fwdcalc-173ab.csv', mode='a',header=False)
    else:
        pass
...
path = '/Users/maddysita/Desktop/CIERA_REU/event-by-event/S0173'
...
def eventoutput(depth,rank):
    ...
    data173a = autofault(data173a, -1.25e-9, 0.955e-9, -0.371e-9, 1.13e-10, 1.46e-10, 2.01e-10)
    print(len(data173a))
    data173a.to_csv(path + '/csvs/ng173a_fullsyn.csv', mode='a', header=False)
    ...
    print('Exit Angles: ', Pe, Se)
    data173ab = autofault(data173ab, 1.09e-9, -1.22e-9, -3.29e-9, 1.13e-10, 1.46e-10, 2.01e-10)
    print(len(data173ab))
    data173ab.to_csv(path + '/csvs/ng173ab_fullsyn.csv', mode='a', header=False)
    return
