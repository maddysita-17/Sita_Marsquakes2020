...
mechanism_dict = {
                    ...
                    'S0235b': [[78,28,86],
                                [280,79,-79],],     # InSight mech as reported in Table 2
                                # [85,20,-90],],     # InSight mech @ 32km
                    }
...
def forwardcalc(depth,mechdic,alt=False):
    ...
    if 'S0235b' in mechdic:
        ...
        for i in range(len(data235b)):
            data235b.at[i,'Model'] = mod
        data235b.to_csv(path+'/fwdcalc-235b.csv', mode='a',header=False)
        ...
        if alt == True:
            ...
            data1.to_csv(path+'/fwdcalc-235b.csv', mode='a',header=False)
    else:
        pass
...
path = '/Users/maddysita/Desktop/CIERA_REU/event-by-event/S0235b'
...
def eventoutput(depth,rank):
    ...
    # ingnoring the zero T comp arrival
    data235b = autofault(data235b, 3.62e-10, 3.47e-9, -1.611e-9, 3.73e-11, 7.03e-11, 7.42e-11)
    # including the early Q comp arrival
    # data235b = autofault(data235b, 3.62e-10, -1.80e-09, 0, 3.73e-11, 7.03e-11, 7.42e-11)
    print(len(data235b))
    data235b.to_csv(path + '/csvs/ng235b_fullsyn.csv', mode='a', header=False)
