...
#
# st_uvw = waveforms(begin, end, 400)
# st_z12 = uvw2enz(st_uvw)
#
# stf = st_z12.copy()
# stf.filter('bandpass', freqmin = 0.125, freqmax = 1.0, corners=4, zerophase=True)
# # stf.filter('bandpass', freqmin = 0.05, freqmax = 1.0, corners=4, zerophase=True)
# hhe = stf[0].data
# hhn = stf[1].data
# hhz = stf[2].data
#
...
#
#
# stP_og = streamRT.slice(starttime=begin-30,endtime=begin+20)
# stS_og = streamRT.slice(starttime=end-30, endtime=end+25)
#
#
# # In[15]:
#
...
# mtimes = Mars.get_travel_times(source_depth_in_km = 35, distance_in_degree = 38.4, phase_list =['P','S'])
# print(mtimes)
...
begin = UTCDateTime('2019-10-26T06:58:57.9')  # p-wave arrival
end = UTCDateTime('2019-10-26T07:02:46.1')    # s-wave arrival
...
# our og calculated bAz -> 123+180 = 303
# insight bAz -> 57+180 = 237
hhT,hhR = rotate(hhe,hhn,237)
...
stP_og = streamRT.slice(starttime=begin-20,endtime=begin+15)
stS_og = streamRT.slice(starttime=end-20, endtime=end+25)
